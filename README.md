...
本项目核心的端侧转写与复盘代码完全开源免费，并基于极度宽松的 [MIT License](LICENSE) 许可证分发。

我们秉持 **Community over Code** 的社区文化。这意味着：
您可以极其自由地使用、复制、修改、合并、出版发行、散布、再授权甚至贩售本软件及其副本。您唯一的义务是：**在软件和软件的所有副本或主要部分中，都必须包含原有的版权声明和许可声明。**
